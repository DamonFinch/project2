...
const ShareModal = () => {
  const isShareModalVisible = useAppSelector(
    state => state.app.isShareModalVisible
  )
  ...
  const onClose = useCallback(() => {
    dispatch(setIsShareModalVisible(false))
  }, [dispatch])
  ...
  return (
    <Modal isVisible={isShareModalVisible} onClose={onClose}>
      ...
      >
        ...
        <Typography
          type='body'
          className='mt-2 !text-base !leading-[1.6rem] text-grayMedium'
        >
