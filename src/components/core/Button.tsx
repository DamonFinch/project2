...
const styles = {
  ...
  variants: {
    primary: {
      filled:
        'bg-here-purple-900 text-white border-here-purple-900 hover:opacity-95 transition-opacity',
      outlined:
        'border-here-purple-900 bg-white text-here-purple-900  hover:opacity-95 transition-opacity'
    },
    light: {
      filled:
        'bg-white text-gray-500 border-gray-300 hover:opacity-95 transition-opacity',
      outlined: ''
    }
  },
  states: {
