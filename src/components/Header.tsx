...
function Header() {
  ...
  return (
    <React.Fragment>
      ...
      <header className='flex items-center justify-center fixed left-0 top-0 w-full z-[30] bg-white h-[72px] min-h-[72px] max-h-[72px]'>
        <div className='flex justify-between items-center w-full max-w-[100rem] px-2 md:px-4 lg:px-28 py-3'>
          <Link href={!!selectedAccount ? '/home' : '/'}>
            <Image
              src={Logo}
              alt='Logo'
              width={150}
              ...
              <React.Fragment>
                ...
                <div className='relative z-10' ref={accountMenuRef}>
                  ...
                  {openAccount && (
                    ...
                    >
                      <div
                        className='flex items-center gap-2 h-12 bg-lightPurple px-2 md:px-4 py-6'
                        onClick={() =>
