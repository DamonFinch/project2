...
const MiniPost = ({
  ...
  return (
    ...
    >
      <div className='py-[0.59375rem] max-w-[57.75rem] w-full flex flex-row justify-between items-center'>
        <div className='flex flex-row gap-2 flex-1 item-start justify-center items-center'>
          <Typography
            type='body'
            className='text-baseWhite !text-base !leading-[1.6rem] font-medium'
          >
            @{verified ? displayName : userIdHash}
          </Typography>

          <div
            className='!text-sm flex-1 !leading-[1.4rem] min-w-[18.75rem] text-grayL font-medium line-clamp-1'
