...
const NotificationsPopup = () => {
  ...
  return (
    <div
      className='max-h-[calc(100vh-150px)] overflow-auto absolute top-12 divide-y-[1px] divide-[#E6E6E6] rounded-[8px]'
      style={{
        boxShadow:
    ...
    >
      <div
        className={`min-w-[20rem] max-w-[25rem] flex items-center gap-2 bg-lightPurple p-4`}
      >
