  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-2 items-center justify-center'>
        ...
        <Typography
          type='body'
          className='text-center !text-base !font-[300] !text-[#858D9D] italic'
        >
          @{data?.userIdHash}
        </Typography>
      </div>
      ...
      >
        ...
        <div className='flex flex-col gap-2'>
          <label
            className='text-base font-normal leading-[1.6rem] text-grayMedium'
            htmlFor='password'
          >
            Password
          </label>
        ...
        <Button
          ...
          size='small'
          outlined={false}
          className='py-1 px-6 rounded-lg h-10 sm:h-12'
          disabled={loading}
        >
          <Typography
            type='button'
