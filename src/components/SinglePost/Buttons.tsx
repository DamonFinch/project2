...
function Buttons({ post, commentors }: Props) {
  const { bookMarks, _id: postId, replies } = post
  ...
  return (
    <div className='flex flex-row justify-between items-center pt-2 pb-6 px-4 bg-baseWhite ml-0 sm:ml-[4.25rem] border border-t-0 border-stroke'>
      {/* Comment button */}
      <CommentButton
