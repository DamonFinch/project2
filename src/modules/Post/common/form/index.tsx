  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-2'>
        ...
        {(fieldError || postError || isAlreadyPublished) && (
          <Typography type='body' className='text-red-500'>
            {fieldError ||
              postError ||
              (isAlreadyPublished &&
      ...
      {isAlreadyPublished ? (
        <div className='flex flex-row gap-4 items-stretch flex-wrap justify-end'>
          <Button
            type='button'
            onClick={onCancel}
            className='bg-transparent rounded-lg px-6 py-2 h-12 !border border-stroke bg-baseWhite !font-medium !text-grayMedium !text-base !leading-[1.2rem] tracking-medium'
          >
            Cancel
          </Button>
          ...
          <Button
            ...
            className='rounded-lg px-6 py-2 !text-baseWhite !bg-header font-medium h-12 tracking-medium !text-base !leading-[1.2rem] !border'
          >
            Continue Publishing...
          </Button>
        </div>
        ...
        <Tooltip
          id='publishButton'
          message={`1μ to ${actionLabel}`}
          className='self-end'
        >
          <Button
            className={`!bg-primary !border-primary action-btn !text-base !leading-[1.2rem] tracking-medium font-medium !px-6 !py-[0.90625rem] ${
              isButtonDisabled
                ? 'cursor-not-allowed'
                : 'cursor-pointer'
            }`}
